      ...
      <div className="relative flex w-full flex-col overflow-hidden">
        ...
        <ChatMainContent>
          ...
          <div className="bg-background relative mx-auto w-full max-w-192 shrink-0 p-3 md:p-4">
            ...
            />
            <AiDisclaimer />
            <div className="flex items-center justify-center gap-2 py-1 text-[10px] text-muted-foreground/40">
              ...
              >
                <svg aria-label="Wahl.chat" className="h-3.5 w-auto" fill="none" viewBox="0 0 368 201" xmlns="http://www.w3.org/2000/svg">
